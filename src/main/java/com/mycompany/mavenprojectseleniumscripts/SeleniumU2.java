...
public class SeleniumU2 {
    ...
    @Test
    public void testCreatePagePostCatTag_Check() throws Exception {

        //Login
        driver.get(baseUrl + "/wordpress/wp-login.php");
        driver.findElement(By.xpath("//*[@id=\"user_login\"]")).clear();
        driver.findElement(By.xpath("//*[@id=\"user_login\"]")).sendKeys("arpita");
        driver.findElement(By.xpath("//*[@id=\"user_pass\"]")).clear();
        driver.findElement(By.xpath("//*[@id=\"user_pass\"]")).sendKeys("arpita");
        ...
        for (int second = 0;; second++) {
            ...
            try {
                if ("Dashboard ‹ Arpita's Blog — WordPress".equals(driver.getTitle())) {
        ...
        for (int second = 0;; second++) {
            ...
            try {
                if ("Pages ‹ Arpita's Blog — WordPress".equals(driver.getTitle())) {
        ...
        for (int second = 0;; second++) {
            ...
            try {
                if ("Add New Page ‹ Arpita's Blog — WordPress".equals(driver.getTitle())) {
        ...
        for (int second = 0;; second++) {
            ...
            try {
                if ("Add New Post ‹ Arpita's Blog — WordPress".equals(driver.getTitle())) {
